...
public class Company {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Para isso, o programa deve ler um id e o valor X. Se o id informado não existir, mostrará uma mensagem e abortar
         a operação.
        Ao final, mostrará listagem atualizada dos funcionários, conforme exemplos.
