...
public class ProgramComparator {
    public static void main(String[] args) {
        ...
        //||        ------------->> Métodos disponíveis para chamar a classe Comparator <<-----------------
        ...
        System.out.println("------>>>   Com a Implementação da Classe myComparator:   <<<----------------------------");
        ...
        System.out.println("------------>>>   Com a Implementação da Classe Anonima   <<<----------------------------");
        ...
        System.out.println("------------>>>   Com a Implementação da Expressão Lambda   <<<--------------------------");

        for (Product prod : list) {
            System.out.println(prod);
        }
        System.out.println();                                      // Quebra de linha
        System.out.println("------------>>>   Com a Implementação da Expressão Lambda Resumida   <<<-----------------");
