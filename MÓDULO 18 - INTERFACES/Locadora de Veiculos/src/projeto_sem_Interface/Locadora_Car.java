...
import projeto_sem_Interface.models.Vehicle;
import projeto_sem_Interface.service.BrazilTaxService;
import projeto_sem_Interface.service.RentalService;

import java.text.ParseException;

public class Locadora_Car {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    */
    ...
    System.out.print("Data de Retirada (dd/MM/yyyy HH:mm): | Pickup (dd/MM/yyyy HH:mm): ");
    Date dateStart = sdf.parse(scan.nextLine());

    System.out.print("Data de Devolução (dd/MM/yyyy HH:mm): | Return (dd/MM/yyyy HH:mm): ");
