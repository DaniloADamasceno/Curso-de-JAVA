...
public class LocadoraCarWithInterface {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    Price per hour: R$10.00                               |                 Price per hour: R$10.00
    Price per day: R$130.00                               |                 Price per day: R$130.00
                                                          |
    INVOICE:                                              |                  INVOICE:
    Basic payment: $$50.00                                |                  Basic payment: R$390.00
    Tax: 10.00                                            |                  Tax: R$58.50
    Total payment: R$60.00                                |                  Total payment: R$448.50
    ----------------------------------------------------- | ----------------------------------------------------------------
    */
