...
public class ProgramMaster {
    ...
    /*
        ...
        // cria uma lista de figuras geométricas
        List<GeometricShape> geometricShapes = new ArrayList<>();
        for (int i = 1; i <= numFiguras; i++) {
            ...
            System.out.println("type the letter of the color of the geometric figure");
