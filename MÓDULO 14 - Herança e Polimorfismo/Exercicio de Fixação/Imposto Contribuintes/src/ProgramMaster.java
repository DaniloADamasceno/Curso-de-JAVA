...
public class ProgramMaster {
    public static void main(String[] args) throws ParseException {
        ...
        *        Pessoa física:
        pessoas cuja renda foi abaixo de R$20000.00 pagam 15% de imposto.
        Pessoas com renda de R$20000.00 em diante pagam 25% de imposto.
        Se a pessoa teve gastos com saúde, 50% destes gastos são abatidos no imposto.
        
        Exemplo: uma pessoa cuja renda foi R$50000.00 e teve R$2000.00 em gastos com saúde, o imposto
        fica: (50000 * 25%) - (2000 * 50%) = R$11500.00
        
        *        Pessoa jurídica:
        pessoas jurídicas pagam 16% de imposto. Porém, se a empresa possuir mais de 10
        funcionários, ela paga 14% de imposto.
        
        Exemplo: uma empresa cuja renda foi R$400000.00 e possui 25 funcionários, o imposto fica:
        400000 * 14% = R$56000.00
         */
